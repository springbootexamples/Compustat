...
The following sample query returns the earnings and shares used to validate the Compustat values for Primary 
EPS (EPSPX and EPSPI) and Fully Diluted (EPSFX and EPSFI) in Xpressfeed

...
b.qunit, 
d.trfd, 
( ( ( ( ( a.prccd / (coalesce(a.qunit,1)*a.ajexdi )) * ( coalesce(c.trfd, 1) ) ) / ( ( b.prccd / (coalesce(B.qunit,1)*b.ajexdi )) * ( coalesce(d.trfd, 1) ) ) ) - 1 ) * 100 ) AS totalreturn
...
AND a.datadate BETWEEN coalesce(c.datadate, '1950-01-01') 
AND coalesce (c.thrudate, '2900-01-01')
AND b.datadate BETWEEN  coalesce(d.datadate, '1950-01-01') 
AND  coalesce (d.thrudate, '2900-01-01')
AND a.gvkey = '007163'
AND a.iid = '01'

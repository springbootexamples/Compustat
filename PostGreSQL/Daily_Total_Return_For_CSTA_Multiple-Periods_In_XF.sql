...
, b.CURCDD
, ( ( ( ( ( a.PRCCD/ a.AJEXDI ) * COALESCE ( c.TRFD,1 ) ) / ( ( b.PRCCD/b.AJEXDI ) * COALESCE ( d.TRFD,1 ) ) ) -1 ) *100 ) AS TotalReturn1
, ( ( ( ( ( a.PRCCD/ a.AJEXDI ) * COALESCE ( c.TRFD,1 ) ) / ( ( e.PRCCD/e.AJEXDI ) * COALESCE ( g.TRFD,1 ) ) ) -1 ) *100 ) AS TotalReturn3Yr
, ( ( ( ( ( a.PRCCD/ a.AJEXDI ) * COALESCE ( c.TRFD,1 ) ) / ( ( f.PRCCD/f.AJEXDI ) * COALESCE ( h.TRFD,1 ) ) ) -1 ) *100 ) AS TotalReturn5Yr
...
AND a.IID = c.IID
AND '2013-03-06' BETWEEN coalesce ( c.DATADATE, '1900-01-01' ) AND COALESCE ( c.THRUDATE, '2900-01-01' )

LEFT JOIN sec_dtrt d ON a.GVKEY = d.GVKEY

AND a.IID = d.IID
AND '2012-03-06' BETWEEN COALESCE ( d.DATADATE, '1900-01-01' ) AND COALESCE ( d.THRUDATE, '2900-01-01' )
...
AND a.IID = g.IID
AND '2010-03-06' BETWEEN COALESCE ( g.DATADATE, '1900-01-01' ) AND COALESCE ( g.THRUDATE, '2900-01-01' )

LEFT JOIN sec_dtrt h ON a.GVKEY = h.GVKEY 

AND a.IID = h.IID 
AND '2008-03-06' BETWEEN COALESCE ( h.DATADATE, '1900-01-01' ) AND COALESCE ( h.THRUDATE, '2900-01-01' )

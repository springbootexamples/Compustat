...
, company.fyrc ,co_filedate.filedate 
...
AND CAST(co_filedate.filedate AS DATE) = cast(co_filedate.datadate + interval '60 DAY' as date) ---( DATEADD ( DAY, 60, CAST( co_filedate.datadate AS DATE) ) ) 

...
AND CAST(a.datadate AS DATE) = cast('2020-03-31' as date) - interval '12 MON' -- ( DATEADD (m, -12, '2020-03-31') )
AND CAST(b.datadate AS DATE) = cast('2020-03-31' as date) - interval '4 day' --( DATEADD (d, -4, '2020-03-31') ) -- if the days subtracted dont have prices, query wont yield results
AND a.gvkey = '020344'

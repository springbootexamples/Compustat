...
SET (GVKey,IID,StartDate,EndDate)= ('014894','01W','2002-01-02','2001-12-03') ;--Enter the GVKey
...
AND $EndDate BETWEEN c.datadate AND IFNULL ( c.thrudate , '2900-01-01' )AND $StartDate BETWEEN d.datadate AND IFNULL ( d.thrudate , '2900-01-01' )
AND a.gvkey = $GVKey
AND a.iid = $IID

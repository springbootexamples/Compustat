...
SET (BeginDate,EndDate,Gvkey) = ('1/1/2020',getdate(),'006066');
...
join sec_dtrt t1 on t1.gvkey = s1.gvkey
        and t1.iid = s1.iid     
        and s1.datadate BETWEEN t1.datadate and IFnull( t1.thrudate, '1/1/2900')

join sec_dtrt t2 on t2.gvkey = s2.gvkey
        and t2.iid = s2.iid
        and s2.datadate BETWEEN t2.datadate and IFnull( t2.thrudate, '1/1/2900')

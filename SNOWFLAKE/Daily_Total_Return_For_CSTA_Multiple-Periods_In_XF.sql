...
, b.CURCDD
, ( ( ( ( ( a.PRCCD/ a.AJEXDI ) * IFNULL ( c.TRFD,1 ) ) / ( ( b.PRCCD/b.AJEXDI ) * IFNULL ( d.TRFD,1 ) ) ) -1 ) *100 ) AS TotalReturn1
, ( ( ( ( ( a.PRCCD/ a.AJEXDI ) * IFNULL ( c.TRFD,1 ) ) / ( ( e.PRCCD/e.AJEXDI ) * IFNULL ( g.TRFD,1 ) ) ) -1 ) *100 ) AS TotalReturn3Yr
, ( ( ( ( ( a.PRCCD/ a.AJEXDI ) * IFNULL ( c.TRFD,1 ) ) / ( ( f.PRCCD/f.AJEXDI ) * IFNULL ( h.TRFD,1 ) ) ) -1 ) *100 ) AS TotalReturn5Yr
...
AND a.IID = c.IID
AND '2013-03-06' BETWEEN IFNULL ( c.DATADATE, '1900-01-01' ) AND IFNULL ( c.THRUDATE, '2900-01-01' )

LEFT JOIN sec_dtrt d ON a.GVKEY = d.GVKEY

AND a.IID = d.IID
AND '2012-03-06' BETWEEN IFNULL ( d.DATADATE, '1900-01-01' ) AND IFNULL ( d.THRUDATE, '2900-01-01' )
...
AND a.IID = g.IID
AND '2010-03-06' BETWEEN IFNULL ( g.DATADATE, '1900-01-01' ) AND IFNULL ( g.THRUDATE, '2900-01-01' )

LEFT JOIN sec_dtrt h ON a.GVKEY = h.GVKEY 

AND a.IID = h.IID 
AND '2008-03-06' BETWEEN IFNULL ( h.DATADATE, '1900-01-01' ) AND IFNULL ( h.THRUDATE, '2900-01-01' )

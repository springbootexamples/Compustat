...
AND CAST(a.datadate AS DATE) = ( DATEADD (month, -12, '2020-03-31'))  
AND CAST(b.datadate AS DATE) = ( DATEADD (day, -4, '2020-03-31') ) -- if the days subtracted dont have prices, query wont yield results
AND a.gvkey = '020344'

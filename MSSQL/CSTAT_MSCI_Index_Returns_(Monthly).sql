/************************************************************************************************
Pulling MSCI Index Returns(Monthly)
...
This query returns monthly data in the local currency.
Note: Uncomment the second query to return returns Monthly data in U.S. Dollars (USD).

...
This query is used to screen Xpressfeed for closed-end funds only, search for SIC code of 6726, 
Issue Type (TPCI) of 7 (Mutual or investment trust fund), and Net Asset Value (NAVM) is a value.

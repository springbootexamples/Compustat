...
DECLARE @gvkey AS VARCHAR ( 6 ) SET @gvkey = '016603' --First query subtracts Q2 ytd from Q4 ytd to get second half cash flow:
...
AND y2.datadate = DATEADD ( mm, -6, y2.datadate )
